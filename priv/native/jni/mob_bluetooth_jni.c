...
Java_io_mob_bluetooth_MobBluetoothBridge_nativeDeliverBtDiscoveryStarted(JNIEnv* env, jclass cls,
    jlong pid) {
    mob_deliver_bt_discovery_started(pid);
}

JNIEXPORT void JNICALL
Java_io_mob_bluetooth_MobBluetoothBridge_nativeDeliverBtDiscoveryFinished(JNIEnv* env, jclass cls,
    jlong pid) {
    mob_deliver_bt_discovery_finished(pid);
}

JNIEXPORT void JNICALL
Java_io_mob_bluetooth_MobBluetoothBridge_nativeDeliverBtDiscoveryCancelled(JNIEnv* env, jclass cls,
    jlong pid) {
    mob_deliver_bt_discovery_cancelled(pid);
}

JNIEXPORT void JNICALL
Java_io_mob_bluetooth_MobBluetoothBridge_nativeDeliverBtDiscovered(JNIEnv* env, jclass cls,
...
JNIEXPORT void JNICALL
Java_io_mob_bluetooth_MobBluetoothBridge_nativeDeliverBtPaired(JNIEnv* env, jclass cls,
    jlong pid, jstring address, jstring name, jboolean bonded) {
    const char* c_address = (*env)->GetStringUTFChars(env, address, NULL);
    const char* c_name    = (*env)->GetStringUTFChars(env, name,    NULL);
...
JNIEXPORT void JNICALL
Java_io_mob_bluetooth_MobBluetoothBridge_nativeDeliverBtPairFailed(JNIEnv* env, jclass cls,
...
JNIEXPORT void JNICALL
Java_io_mob_bluetooth_MobBluetoothBridge_nativeDeliverBtUnpaired(JNIEnv* env, jclass cls,
...
JNIEXPORT void JNICALL
Java_io_mob_bluetooth_MobBluetoothBridge_nativeDeliverBtError(JNIEnv* env, jclass cls,
...
JNIEXPORT void JNICALL
Java_io_mob_bluetooth_MobBluetoothBridge_nativeDeliverBtPairedListBegin(JNIEnv* env, jclass cls,
    jlong pid) {
    mob_deliver_bt_paired_list_begin(pid);
}

JNIEXPORT void JNICALL
Java_io_mob_bluetooth_MobBluetoothBridge_nativeDeliverBtPairedListEntry(JNIEnv* env, jclass cls,
    jlong pid, jstring address, jstring name, jboolean bonded) {
    const char* c_address = (*env)->GetStringUTFChars(env, address, NULL);
    const char* c_name    = (*env)->GetStringUTFChars(env, name,    NULL);
...
JNIEXPORT void JNICALL
Java_io_mob_bluetooth_MobBluetoothBridge_nativeDeliverBtPairedListFinish(JNIEnv* env, jclass cls,
    jlong pid) {
...
JNIEXPORT void JNICALL
Java_io_mob_bluetooth_MobBluetoothBridge_nativeDeliverBtHfpConnecting(JNIEnv* env, jclass cls,
...
JNIEXPORT void JNICALL
Java_io_mob_bluetooth_MobBluetoothBridge_nativeDeliverBtHfpConnected(JNIEnv* env, jclass cls,
...
JNIEXPORT void JNICALL
Java_io_mob_bluetooth_MobBluetoothBridge_nativeDeliverBtHfpConnectFailed(JNIEnv* env, jclass cls,
    jlong pid, jstring address, jstring reason) {
    const char* c_address = (*env)->GetStringUTFChars(env, address, NULL);
    const char* c_reason  = (*env)->GetStringUTFChars(env, reason,  NULL);
...
JNIEXPORT void JNICALL
Java_io_mob_bluetooth_MobBluetoothBridge_nativeDeliverBtHfpDisconnected(JNIEnv* env, jclass cls,
...
JNIEXPORT void JNICALL
Java_io_mob_bluetooth_MobBluetoothBridge_nativeDeliverBtHfpVendorSubscribed(JNIEnv* env, jclass cls,
    jlong pid, jint session) {
    mob_deliver_bt_hfp_vendor_subscribed(pid, (int)session);
}

JNIEXPORT void JNICALL
Java_io_mob_bluetooth_MobBluetoothBridge_nativeDeliverBtHfpVendorAt(JNIEnv* env, jclass cls,
...
JNIEXPORT void JNICALL
Java_io_mob_bluetooth_MobBluetoothBridge_nativeDeliverBtHfpScoStarted(JNIEnv* env, jclass cls,
    jlong pid, jint session, jstring address) {
    const char* c_address = (*env)->GetStringUTFChars(env, address, NULL);
...
JNIEXPORT void JNICALL
Java_io_mob_bluetooth_MobBluetoothBridge_nativeDeliverBtHfpScoStopped(JNIEnv* env, jclass cls,
    jlong pid, jint session) {
...
JNIEXPORT void JNICALL
Java_io_mob_bluetooth_MobBluetoothBridge_nativeDeliverBtSppConnected(JNIEnv* env, jclass cls,
    jlong pid, jint session, jstring address, jstring name) {
    const char* c_address = (*env)->GetStringUTFChars(env, address, NULL);
    const char* c_name    = (*env)->GetStringUTFChars(env, name,    NULL);
...
JNIEXPORT void JNICALL
Java_io_mob_bluetooth_MobBluetoothBridge_nativeDeliverBtSppConnectFailed(JNIEnv* env, jclass cls,
    jlong pid, jstring address, jstring reason) {
    const char* c_address = (*env)->GetStringUTFChars(env, address, NULL);
    const char* c_reason  = (*env)->GetStringUTFChars(env, reason,  NULL);
...
JNIEXPORT void JNICALL
Java_io_mob_bluetooth_MobBluetoothBridge_nativeDeliverBtSppDisconnected(JNIEnv* env, jclass cls,
    jlong pid, jint session, jstring reason) {
    const char* c_reason = (*env)->GetStringUTFChars(env, reason, NULL);
...
JNIEXPORT void JNICALL
Java_io_mob_bluetooth_MobBluetoothBridge_nativeDeliverBtSppData(JNIEnv* env, jclass cls,
...
JNIEXPORT void JNICALL
Java_io_mob_bluetooth_MobBluetoothBridge_nativeDeliverBtSppWritten(JNIEnv* env, jclass cls,
    jlong pid, jint session, jint size) {
    mob_deliver_bt_spp_written(pid, (int)session, (int)size);
}

JNIEXPORT void JNICALL
Java_io_mob_bluetooth_MobBluetoothBridge_nativeDeliverBtSppError(JNIEnv* env, jclass cls,
    jlong pid, jint session, jstring reason) {
    const char* c_reason = (*env)->GetStringUTFChars(env, reason, NULL);
